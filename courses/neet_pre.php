...
<body>
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        <h6 class="section-title bg-white text-center px-3 mt-5">Course</h6>
        <h1 class="mb-5">IIT/NEET Pre-Foundation(9th & 10th)</h1>
    </div>
    <div class="container">
...
challenges ahead and ensure that they are well-equipped for the next phase of their academic journey.</p>               
           ...
           <div class="col-md-3 mt-2">
            <div class="courses_menu">
                ...
                <a href="cbsc school.php">CBSE School ( 1st to 12th standard)</a>
                <a href="cbsc_icsc.php">CBSE/ICSE ( Academic Coaching )</a>
                <a href="neet_pre.php">IIT/NEET Pre-Foundation(9th & 10th)</a>
                <a href="neet_foundation.php">IIT/NEET Foundation ( 11th & 12th )</a>
                <a href="neet_target.php">IIT/NEET Target ( 12th Pass)</a>
                <a href="nda.php">CUET/NDA ( 11th & 12th )</a>    
            </div>                              
           </div>             
        </div>
    </div>     
