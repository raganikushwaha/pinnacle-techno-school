...
<body>
        ...
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center mt-3">
                    <h1 class="display-3 text-white animated slideInDown">About P-STAR</h1>
    ...
    <section class="mt-3 pstar-section">

        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title bg-white text-center px-3">P-STAR - 2024</h6>
            <h1 class="">Pinnacle Star Reward Exam</h1>
        ...
        <div class="container exam-hero">
            ...
            <div class="row text-center my-3">
                <div class="col-12">
                    <button class="register-now-button"><a href="../P-STAR/register.php">Register Now</a></button>
                </div>
            </div>
        </div>
        <div class="container wow fadeInUp text-center">
            <p class="mt-3" style="max-width: 700px; margin: auto;">P-STAR brings an amazing opportunity for the young talents to pave their way towards an
        ...
        <div class="container wow fadeInUp text-center mt-5" style="margin: auto; max-width: 900px; width: 100%;">
            <div class="row">
                <div class="col-12 p-star" style="background-color: #ffe9cd; border: none;">
                    ...
                    <h4>Every student presently in Class V, VI, VII, VIII, IX, X & XI MUST appear in the P-STAR Test whether he / she is</h4>
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="p-star info-box">
                        ...
                        <div class="info">
                            ...
                            <span class="">P-STAR Exam will be conducted in Offline mode only for 5th to 12th.</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-4">
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="p-star info-box">
                        ...
                        <div class="info">
                            ...
                            <span class="">On the basis of P-STAR results we Provides scholarship for admission in
                                pinnacle</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="p-star info-box">
                        ...
                        <div class="info">
                            ...
                            <span class="">On the basis of P-STAR results we Provides Certificate </span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-4">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="info">
                            ...
                            <span class="sub">Take the first step for your better future by registering for P-STAR
                                (Pinnacle Star Reward Exam)</span>
                            <div class="on_off_reg_block">
                                ...
                                <div class="desc">
                                    <p class="m-0">1. Choose the register button among the dropdown list of P-STAR </p>
                                    <p class="m-0">2. Fil in the personal details in the registration form and submit
                                        the form. </p>
                                    <p class="m-0">3. Get your Admit Card for P-STAR Stage-1 & take the printout of it
                            ...
                            <div class="on_off_reg_block">
                                ...
                                <div class="desc">
                                    <p class="m-0">Take form from your school if it has agreed for P-STAR registration,
    ...
    <section class="ptqe_syllabus_section wow fadeInUp mt-5">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">P-STAR Syllabus & Pattern </h1>
                ...
                <div class="row wow fadeInUp mt-5">
                    ...
                    <div class="col-12">
                        <div class="section_header text-center wow fadeInUp mt-5">
                            <h2 class=" fw-800">P-STAR stage-1 Sample Papers</h2><br><br>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="row">
    ...
    <div class="container wow fadeInUp text-center">
        <div class="row">
            <div class="col-12 p-star" style="background-color: #ffe9cd;">
                ...
                <p class="checklist"><img src="../images/pstar-2024/icon1.png" alt="" style="float: left;"> These programs will optimally prepare you for NTSE, Junior Olympiads and at least for the IOQM. No matter what your current academic performance is, a P-STAR program can help you undergo a metamorphosis.</p>
            </div>
        </div>
    ...
    <section class="why_ptqe_section bg_01 wow fadeInUp mt-5">
        ...
        <div class="why_ptqe_block container">
            <div class="row">
                <div class="col-12">
                    <div class="section_header text-center">
                        <h2 class=" fw-800 ">Why P-STAR is Different ? ...</h2>
                    </div>
                </div>
            </div>
            <div class="why_ptqe d-flex align-items-center" style="flex-wrap: wrap;">
                <div class="why_ptqe_box">
                    ...
                    <div class="desc">
                        <p>
                            P-STAR is the initial step for career aspirants to reach at Pinnacle of their set goals. In
                ...
                <div class="why_ptqe_box">
                    ...
                    <div class="desc">
                        <p>
                            P-STAR question papers are designed meticulously taken in consideration the scientifically &
